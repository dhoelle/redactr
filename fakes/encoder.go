...
func (fake *Encoder) Encode(arg1 string) (string, error) {
...
func (fake *Encoder) EncodeCallCount() int {
	fake.encodeMutex.RLock()
	defer fake.encodeMutex.RUnlock()
	return len(fake.encodeArgsForCall)
}

func (fake *Encoder) EncodeCalls(stub func(string) (string, error)) {
	fake.encodeMutex.Lock()
	defer fake.encodeMutex.Unlock()
	fake.EncodeStub = stub
}

func (fake *Encoder) EncodeArgsForCall(i int) string {
	fake.encodeMutex.RLock()
	defer fake.encodeMutex.RUnlock()
...
func (fake *Encoder) EncodeReturns(result1 string, result2 error) {
	fake.encodeMutex.Lock()
	defer fake.encodeMutex.Unlock()
	fake.EncodeStub = nil
...
func (fake *Encoder) EncodeReturnsOnCall(i int, result1 string, result2 error) {
	fake.encodeMutex.Lock()
	defer fake.encodeMutex.Unlock()
	fake.EncodeStub = nil
...
func (fake *Encoder) Invocations() map[string][][]interface{} {
...
func (fake *Encoder) recordInvocation(key string, args []interface{}) {
...
var _ cryptr.Encoder = new(Encoder)
